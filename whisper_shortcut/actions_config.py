...
import pyperclip
from prompts import system_prompt_with_input, system_prompt_default, user_prompt_template
from shortcuts import super_key
...
actions = [
    WhisperTranscribe(shortcut=super_key | {keyboard.KeyCode.from_char("2")}),
